  ...
  return (
    <div className="w-full min-h-screen pt-32 pb-24 px-6">
      <div className="max-w-4xl mx-auto">
        <PageHeader label="Get in Touch" title="Contact Us" titleClassName="text-4xl md:text-6xl" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <ul className="font-asans text-slate-700 text-base md:text-lg space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Office 208, Academic Building 1C
                    <br />
                ...
                <li className="flex items-center gap-3">
                  <span className="text-cyan-600">📧</span>
                  <a href="mailto:ankur@iiserb.ac.in" className="text-cyan-700 font-semibold hover:underline transition-all">
                    ankur@iiserb.ac.in
                  </a>
                </li>
                <li className="flex items-center gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-cyan-700 font-semibold hover:underline transition-all"
                    >
                      linkedin
                    </a>
                  </div>
            ...
            <div className="bg-cyan-50/50 rounded-2xl p-8 border border-cyan-100">
              ...
              <p className="font-asans text-slate-600 text-sm leading-relaxed mb-6">
                We are always looking for motivated students to join us in exploring the frontiers of quantum information
                science.
              </p>
              <a
