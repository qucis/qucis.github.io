...
const Team = () => {
  ...
  const members = [
    ...
    { id: 4, name: "Ronit Raj", position: "B.S. Student", img: "/members/ms/ronit.png", bio: "Ronit is currently working on his BS project at QuCIS lab." },
    { id: 5, name: "Manish Mallapur", position: "B.S. Student", img: "/members/ms/manish.png", bio: "Manish is currently working on his BS project at QuCIS lab." },
  ];
  ...
  const alumni = [
    ...
    { id: 3, name: "Pranav Maheshwari", position: "M.S. Student", img: "/members/alumni/pranav.png", bio: "A Quantum Information Researcher who loves talking about life, politics and entrepreneurship. Excited to meet new faces and waiting for you to send a Hi!" },
