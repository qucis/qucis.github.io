...
const LatestUpdates = () => {
    const updates = [
        {
            date: "March 2026",
            text: "Our QuCIS Lab had a wonderful time participating in the EECS Research Symposium 2026 held at IISER Bhopal on March 11–12, 2026. It was an exciting opportunity for our group to share our research, exchange ideas, and engage with the vibrant research community."
        }
    ]
    ...
    return (
        <div className="w-full pb-24 px-6 flex flex-col items-center">
            ...
            <div className="w-full max-w-5xl mx-auto mb-16">
                ...
                <h2 className="font-unbounded font-bold text-3xl md:text-5xl text-slate-900 text-center mb-4">
                    Latest Lab Updates
                </h2>
            ...
            <div className="w-full max-w-4xl space-y-8">
                {updates.map((update, index) => (
                    <div key={index} className="group relative bg-white/60 backdrop-blur-md border border-cyan-100 rounded-2xl p-8 shadow-sm hover:shadow-md hover:border-cyan-300 transition-all flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="flex-grow">
                            <p className="font-asans text-slate-700 text-lg leading-relaxed">
                                {update.text}
                            </p>
                        </div>
